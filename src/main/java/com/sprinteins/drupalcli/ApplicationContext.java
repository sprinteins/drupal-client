...
public class ApplicationContext {
  ...
  public ApplicationContext(String baseUri, GlobalOptions globalOptions) {
    this(baseUri, readApiKey(globalOptions.tokenFile), buildHttpClient(globalOptions),
        initialiseConverter(globalOptions));
  }
  ...
  public ApplicationContext(String baseUri, String apiKey, HttpClient httpClient, Converter initialisedConverter) {
    ...
    releaseNoteParagraphClient = new ParagraphClient<>(
        ...
        httpClient);
    downloadsElementParagraphClient = new ParagraphClient<>(
        objectMapper,
        baseUri, 
        apiKey, 
  ...
  private static HttpClient buildHttpClient(GlobalOptions globalOptions) {
    ...
    CustomProxySearchStrategy searchStrategy = new CustomProxySearchStrategy(globalOptions, System.getenv());
